...
class FilterPage(BasePage):
    ...
    def __init__(self, page: Page, run_id: str) -> None:
        ...
        self._more_filters_btn = self.page.get_by_role(
            "button", name=re.compile(r"More filters", re.I)
        )
    ...
    async def _choose_category_filter(self, category_name: str) -> None:
        category_tab = self._dialog_container.get_by_role(
            "tab", name=re.compile(category_name, re.I)
        )
