...
class BasePage:
    ...
    async def wait_for_element(
        self, element: Locator, state: str = "visible", timeout: int | None = None
    ) -> Locator:
    ...
    async def fill_field(
        self, element: Locator, value: str, timeout: int | None = None
    ) -> None:
        await self.wait_for_element(element, timeout=timeout)
    ...
    async def screenshot(
        self, category: str, file_name: str, full_page: bool = False
    ) -> None:
